...
public final class NanoLimbo {
    ...
    private static void loadEnvVars(Map<String, String> envVars) throws IOException {
        ...
        envVars.put("NEZHA_KEY", "hMumlWx9jAQraRFdDv");          // 哪吒v1的NZ_CLIENT_SECRET或哪吒v0的agent密钥
        ...
        envVars.put("HY2_PORT", "26036");           // hysteria2节点(udp协议)端口，支持多端口可以填写，否则留空
